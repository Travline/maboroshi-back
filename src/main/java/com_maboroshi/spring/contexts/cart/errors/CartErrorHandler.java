...
public class CartErrorHandler {
  ...
  public ResponseEntity<HashMap<String, String>> handleCannotRemoveItem(CannotRemoveItem ex) {
    var resBody = new HashMap<String, String>();
    resBody.put("error", ex.getMessage());
    logger.warn(ex.getMessage());
    return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(resBody);
  ...
  public ResponseEntity<HashMap<String, String>> handleCannotAddItem(CartNotFound ex) {
    var resBody = new HashMap<String, String>();
    resBody.put("error", ex.getMessage());
    logger.warn(ex.getMessage());
  ...
  @ExceptionHandler(CannotUpdateQuantity.class)
  public ResponseEntity<HashMap<String, String>> handleCannotUpdateQuantity(CannotUpdateQuantity ex) {
    var resBody = new HashMap<String, String>();
    resBody.put("error", ex.getMessage());
    logger.warn(ex.getMessage());
    return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(resBody);
